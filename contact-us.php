...
<body>
    ...
    <div class="col-md-12 col-lg-8 offset-lg-2">
        <form id="contactForm" class="contact-form" data-toggle="validator" onsubmit="sendEmail(); return false;">
            <div class="row">
                <div class="col-md-6">
...
function sendEmail() {
    ...
    var body = 'From: ' + fname + ' ' + lname + ' (' + email + ')%0D%0A%0D%0A' + message;
    window.location.href = 'mailto:salonliyasoba@gmail.com?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(body);
}
</script>
