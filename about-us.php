...
<body>
    ...
    <!-- end banner -->
    <section id="section-spacing" style="background-color: #D2AACF;">
        <div class="sal">
            <div id="salon" class="page section desktop">
                ...
                <div class="container">
                    ...
                    <div class="sixteen columns py-5">
                        ...
                        <center>
                            <h1 class="display-1"><span style="color: deeppink" >Salon </span>Liya Soba</h1>
                        </center>

                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <img alt="" class="scale-with-grid salonImage one-third column" src="img/cosmetics.jpg" style="width: 80%; height: auto;"> 
                        </div>

                        <div class="col-md-4">
                            <img alt="" class="scale-with-grid salonImage one-third column" src="img/salon-interior.jpg" style="width: 90%; height: auto;"> 
                        </div>

                        <div class="col-md-4">
                            <img alt="" class="scale-with-grid salonImage one-third column" src="img/massage-room.jpg" style="width:100%; height: auto;">
                        </div>
                    </div>
